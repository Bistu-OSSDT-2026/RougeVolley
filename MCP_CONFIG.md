...
- **Root directory**: /c/Users/19559/Ideaprojects/RougeVolley
- **Server command**:
```bash
npx @modelcontextprotocol/server-filesystem --path "/c/Users/19559/Ideaprojects/RougeVolley"
```
...
- **Server command**:
```bash
npx @modelcontextprotocol/server-git --path "/c/Users/19559/Ideaprojects/RougeVolley"
```
